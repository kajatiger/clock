...
class ClockTest < Minitest::Test
  ...
  # Here follow some tests that either go on green magically, or prompt you to
  # refactor your logic.
  ...
  def test_calling_to_s_does_not_get_in_the_way_of_operations
    ...
    assert_equal "12:34", (clock1 + clock2).to_s
  end
  ...
  def test_adding_two_clocks_does_not_change_either_clock
    ...
    assert_equal "12:00", clock1.to_s
    assert_equal "00:34", clock2.to_s
  end
